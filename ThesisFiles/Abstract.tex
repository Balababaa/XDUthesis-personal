...
\begin{abstract}
  ...
  然后介绍了流媒体和流式传输的有关概念，分析比较了RTMP、HTTP-FLV和HLS这三个常用的流媒体传输协议，
...
\end{abstract}
\keywords{流媒体, 流式传输, Spring Boot, HTTP-FLV, 视频实时监控系统}
...
\end{enabstract}
\enkeywords{streaming media, streaming transmission,, Spring Boot, HTTP-FLV, video real-time surveillance system}